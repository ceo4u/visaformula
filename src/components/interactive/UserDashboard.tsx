                ...
                <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-slate-50/50 p-6 rounded-2xl border border-slate-150 space-y-4">
                                ...
                                {visasProcessingState.length === 0 ? (
                                    <div className="text-center py-8 text-xs text-slate-450 font-medium">No active visa applications currently under processing.</div>
                                ) : (
                    ...
                    <div className="bg-white border border-slate-200/50 rounded-3xl p-8 shadow-sm space-y-8 max-w-4xl animate-premium-fade">
                        ...
                        <div className="space-y-4">
                            ...
                            {escrowPaymentsState.length === 0 ? (
                                <div className="text-center py-6 text-xs text-slate-400 font-medium bg-slate-50 border border-dashed border-slate-200 rounded-2xl">
                                    No active escrow payments or locked milestones found.
                                </div>
                            ) : (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-white border border-slate-200/50 rounded-3xl p-8 shadow-sm space-y-6 max-w-4xl animate-premium-fade">
                        ...
                        <div className="space-y-4">
                            ...
                            {previousVisas.length === 0 ? (
                                <div className="text-center py-6 text-xs text-slate-400 font-medium bg-slate-50 border border-dashed border-slate-200 rounded-2xl">
                                    No previous visa history recorded.
                                </div>
                            ) : (
                    ...
                    <div className="bg-white border border-slate-200/50 rounded-3xl p-8 shadow-sm space-y-6 max-w-4xl animate-premium-fade">
                        ...
                        {favouriteExperts.length === 0 ? (
                            <div className="text-center py-10 text-xs text-slate-400 font-medium bg-slate-50 border border-dashed border-slate-200 rounded-2xl w-full">
                                No saved agents or bookmarked experts found.
                            </div>
                        ) : (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-white border border-slate-200/50 rounded-3xl p-8 shadow-sm space-y-6 max-w-4xl animate-premium-fade">
                        ...
                        {reviewsGiven.length === 0 ? (
                            <div className="text-center py-10 text-xs text-slate-400 font-medium bg-slate-50 border border-dashed border-slate-200 rounded-2xl w-full">
                                No reviews or ratings submitted yet.
                            </div>
                        ) : (
                            <div className="space-y-4">
