              ...
              <div className="bg-slate-50/60 rounded-2xl p-6 border border-slate-200/80 shadow-xs space-y-4">
                ...
                <form onSubmit={handleSubmitEvaluation} className="space-y-3.5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full appearance-none bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs font-bold text-slate-800 outline-none focus:border-[#00a896] cursor-pointer shadow-2xs"
                      >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-white border border-slate-200 rounded-xl pl-7 pr-2 py-2 text-xs font-bold text-slate-800 outline-none focus:border-[#00a896] shadow-2xs"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full appearance-none bg-white border border-slate-200 rounded-xl px-2.5 py-2 text-xs font-bold text-slate-800 outline-none focus:border-[#00a896] cursor-pointer truncate shadow-2xs"
                        >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full appearance-none bg-white border border-slate-200 rounded-xl px-2.5 py-2 text-xs font-bold text-slate-800 outline-none focus:border-[#00a896] cursor-pointer shadow-2xs"
                        >
                    ...
                    <div>
                      ...
                      <button
                        ...
                        className="w-full bg-white border border-slate-200 rounded-xl px-3 py-1.5 text-xs font-bold text-slate-800 flex items-center justify-between cursor-pointer shadow-2xs"
                      >
                  ...
                  <button
                    ...
                    className="w-full bg-[#00a896] hover:bg-[#008f80] text-white font-extrabold py-3.5 px-4 rounded-xl text-xs shadow-md transition-all cursor-pointer flex items-center justify-center gap-2 active:scale-98 mt-3"
                  >
                    {isEvaluating ? (
                      <>
            ...
            <div className="space-y-6 animate-premium-fade">
              ...
              <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-white hover:bg-slate-100 text-slate-700 border border-slate-200 text-xs font-bold rounded-xl transition-colors cursor-pointer flex items-center gap-1.5 shadow-2xs"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className="md:col-span-7 bg-white rounded-2xl p-5 border border-slate-200/90 shadow-sm space-y-4 flex flex-col justify-between">
                  <div>
                    <h3 className="text-sm font-extrabold text-[#0c1a2e] mb-3">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-sm font-extrabold text-[#0c1a2e]">Profile Strength</h3>
                      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className="md:col-span-6 bg-white rounded-2xl p-5 border border-slate-200/90 shadow-sm space-y-4">
                  <h3 className="text-sm font-extrabold text-[#0c1a2e] mb-2">Readiness Breakdown</h3>
                ...
                <div className="md:col-span-6 bg-white rounded-2xl p-5 border border-slate-200/90 shadow-sm space-y-3.5">
                  <h3 className="text-sm font-extrabold text-[#0c1a2e] flex items-center gap-2 mb-1">
