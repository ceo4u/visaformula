...
const perks = [
  ...
  { emoji: "⭐",    title: "Quality Review",           desc: "Flag spam, incorrect info, or fake listings. Keep the TravlTik platform trusted and high-quality for all users.",      bg: "bg-violet-50" },
];
...
const joinSteps = [
  ...
  { num: "3", emoji: "✅", title: "TravlTik Approval",     desc: "Our team reviews your application within 48 hours and activates your agent account."                   },
    ...
    <div className="bg-[#fff5f5] min-h-screen text-[#1a3347] font-sans">
      ...
      <div className="max-w-6xl mx-auto px-6 py-14 space-y-16">
        ...
        <div>
          ...
          <h2 className="font-sans font-extrabold text-[#0c1a2e] text-2xl mb-2">What Does a TravlTik Agent Do?</h2>
          <p className="text-sm text-[#475569] mb-8">Agents are the quality backbone of TravlTik — they verify everything before it goes live.</p>
        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="text-center mb-8">
            <a href="/" className="inline-flex items-center gap-2 mb-3">
              ...
              <span className="text-2xl font-extrabold tracking-tight text-[#0c1a2e]">TravlTik</span>
            </a>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-7 md:p-8 shadow-xl">
            {regStep === 1 && (
              <div>
                ...
                <div className="mb-4"><label className="text-[10px] font-medium tracking-normal text-[#94B0C4] block mb-1.5">Why do you want to become a TravlTik Agent?</label>
    ...
    <div className="bg-[#fff5f5] min-h-screen text-[#1a3347] font-sans">
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between shadow-sm sticky top-0 z-40">
        <div className="font-sans font-extrabold text-lg text-[#0c1a2e] flex items-center gap-2">
          <span className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse" />
          TravlTik <span className="text-[#0c1a2e]">·</span>
          ...
          <div className="p-5 border-b border-slate-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[10px] text-[#475569]">TravlTik Agent · Pune</div>
          ...
          {section === "verify-experts" && (
            <div>
              ...
              <VerifyCard
                ...
                name="Priya Sharma" type="Immigration Consultant · Applies to list on TravlTik"
              ...
              <VerifyCard
                ...
                name="Aryan Mathur" type="IELTS Training Institute · Applies to list on TravlTik"
              ...
              <div className="bg-white border border-slate-200 p-6 shadow-sm mb-4">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-[#475569]">TravlTik Agent · Pune, Maharashtra</div>
