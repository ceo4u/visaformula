...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: ["'Google Sans'", "'Product Sans'", "Roboto", "'Open Sans'", "-apple-system", "BlinkMacSystemFont", "'Segoe UI'", "sans-serif"],
        google: ["'Google Sans'", "'Product Sans'", "Roboto", "sans-serif"],
        roboto: ["Roboto", "'Open Sans'", "sans-serif"],
        inter: ["'Google Sans'", "Roboto", "sans-serif"],
        montserrat: ["'Google Sans'", "Roboto", "sans-serif"],
        sora: ["'Google Sans'", "Roboto", "sans-serif"],
        dmsans: ["'Google Sans'", "Roboto", "sans-serif"],
        heading: ["'Google Sans'", "'Product Sans'", "Roboto", "sans-serif"],
        plusjakarta: ["'Google Sans'", "Roboto", "sans-serif"],
        jakarta: ["'Google Sans'", "Roboto", "sans-serif"],
        poppins: ["'Google Sans'", "Roboto", "sans-serif"],
      },
      boxShadow: {
