          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-slate-200/90 space-y-6" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            ...
            {currentStep === 1 && (
              <div className="space-y-5 animate-premium-fade" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                ...
                {/* 1-Click Fast Google Sign-in for Experts */}
                <div className="bg-gradient-to-r from-teal-50/90 to-emerald-50/90 border border-teal-200/80 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-3.5 shadow-xs">
                  <div className="flex items-center gap-3 text-left w-full sm:w-auto">
                    ...
                    <div>
                      <h4 className="text-sm font-extrabold text-slate-900 leading-tight">Fast-Track Expert Onboarding</h4>
                      <p className="text-xs text-slate-500 font-medium">Sign in with Google to open your Consultant Dashboard instantly</p>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    onClick={handleGoogleSignup}
                    disabled={googleLoading}
                    className="w-full sm:w-auto shrink-0 px-5 py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-xl font-bold text-xs flex items-center justify-center gap-2 shadow-md transition-all cursor-pointer active:scale-95 whitespace-nowrap"
                  >
                    {googleLoading ? (
                ...
                <div className="relative flex items-center justify-center my-2">
                  <div className="border-t border-slate-200 w-full" />
                  <span className="bg-white px-3 text-[11px] font-bold text-slate-400 uppercase tracking-widest absolute">Or enter details manually</span>
                </div>
