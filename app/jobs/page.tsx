...
import {
  ...
  ChefHat, GraduationCap, Wrench, Bookmark, BookmarkPlus,
} from "lucide-react";
...
const initialJobs = [
  ...
  },
  {
    ...
    tags: ["Python", "ML/AI", "EU Blue Card", "Remote"],
...
export default function OverseasJobsPage() {
  ...
  return (
    <div className="bg-[#f7fbff] min-h-screen text-[#1a3347] font-sans relative pb-16">
      ...
      {activeJob ? (
        <div className="max-w-4xl mx-auto px-6 py-10">
          <button
            ...
            className="text-xs font-bold text-[#0ea5e9] hover:underline mb-6 flex items-center gap-1.5"
          >
            ← Back to Jobs
          </button>

          {/* Hero Image */}
          <div className="relative rounded-3xl overflow-hidden h-52 mb-6 border border-sky-100 shadow-sm">
            ...
            <div className="absolute bottom-4 left-5 flex items-center gap-2">
              ...
              <span className="text-white font-bold text-sm flex items-center gap-1">
                <MapPin className="w-3.5 h-3.5 text-[#38bdf8]" /> {activeJob.location}
              </span>
            </div>
          </div>
          ...
          <div className="bg-white border border-sky-100 rounded-2xl p-8 shadow-sm">
            <div className="flex gap-4 items-start mb-6">
              <img src={activeJob.logo} alt={activeJob.company} className="w-16 h-16 rounded-2xl object-cover border border-sky-100 bg-white shrink-0 shadow-sm" />
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2 text-sm text-[#475569]">
                  ...
                  <span>•</span>
                  <span className="flex items-center gap-1"><Briefcase className="w-3.5 h-3.5 text-[#0ea5e9]" />{activeJob.type}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
              {[
                ...
                <div key={item.label} className="bg-[#f0f9ff] border border-sky-100 rounded-2xl p-3.5 text-center">
            ...
            <div className="flex flex-wrap gap-2 mb-5">
              {activeJob.tags.map((t: string) => (
                <span key={t} className="bg-sky-50 text-[#0284c7] border border-[#bae6fd] px-3 py-1 rounded-lg text-[10px] font-extrabold uppercase tracking-wider">{t}</span>
              ))}
              {activeJob.sponsorship && <span className="bg-emerald-50 text-emerald-700 border border-emerald-200 px-3 py-1 rounded-lg text-[10px] font-extrabold uppercase tracking-wider flex items-center gap-1"><CheckCircle className="w-3 h-3" />Visa Sponsored</span>}
              {activeJob.relocation && <span className="bg-violet-50 text-violet-700 border border-violet-200 px-3 py-1 rounded-lg text-[10px] font-extrabold uppercase tracking-wider flex items-center gap-1"><Plane className="w-3 h-3" />Relocation</span>}
            </div>

            {/* Description */}
            <div className="border-t border-[#d4e8f5] py-5">
            ...
            <div className="bg-[#f0f9ff] border border-[#bae6fd] rounded-2xl p-5 mb-6">
              <h4 className="text-xs font-bold text-navy flex items-center gap-2 mb-2">
                <Shield className="w-4 h-4 text-[#0ea5e9]" /> Visa & Relocation Package Included
              </h4>
              <p className="text-xs text-gray-500 leading-relaxed font-semibold">
                This employer provides full support — LMIA (Canada), DHA (UAE), TSS 482 (Australia), or EU Blue Card (Germany). Book a Visara immigration expert to fast-track your onboarding.
              </p>
            </div>

            {/* Actions */}
            <div className="flex flex-wrap gap-3 pt-4 border-t border-[#d4e8f5]">
              <button
                onClick={() => showToast("✅ Application submitted successfully!")}
                className="bg-gradient-to-r from-[#38bdf8] to-[#0ea5e9] text-white font-bold text-sm px-7 py-3.5 rounded-2xl shadow-md hover:shadow-lg hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center gap-2"
              >
                Submit Application <ArrowRight className="w-4 h-4" />
              </button>
              <Link href="/find-experts?category=work">
                <button className="bg-white border-2 border-[#bae6fd] text-[#0ea5e9] font-bold text-sm px-5 py-3.5 rounded-2xl hover:bg-[#f0f9ff] transition-all flex items-center gap-2">
        ...
        <div>
          ...
          <div className="relative overflow-hidden" style={{ minHeight: "520px" }}>
            {/* Full-bleed city skyline background — same style as homepage */}
            <div className="absolute inset-0 z-0">
              ...
              />
              {/* Dark navy overlay — same as homepage */}
              <div className="absolute inset-0 bg-gradient-to-b from-[#0c1a2e]/75 via-[#0c1a2e]/60 to-[#0c1a2e]/90" />
              {/* Subtle blue tint */}
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 pt-16 pb-20">
              ...
              {/* Search bar */}
              <div className="bg-white rounded-2xl p-4 shadow-2xl max-w-4xl border border-sky-100">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
                  ...
                  <div className="md:col-span-5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-[#f7fbff] border border-sky-100 rounded-xl pl-10 pr-4 py-2.5 text-sm font-semibold text-navy outline-none focus:border-[#0ea5e9] transition-all placeholder:text-gray-300"
                      />
                    </div>
                  </div>
                  {/* Country */}
                  <div className="md:col-span-3">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="w-full bg-[#f7fbff] border border-sky-100 rounded-xl pl-10 pr-4 py-2.5 text-sm font-semibold text-navy outline-none focus:border-[#0ea5e9] transition-all appearance-none cursor-pointer"
                      >
                  ...
                  <div className="md:col-span-1">
                    <button
                      ...
                      className="w-full h-[42px] bg-gradient-to-r from-[#38bdf8] to-[#0ea5e9] text-white font-bold rounded-xl shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center"
                    >
                ...
                {/* Toggle row */}
                <div className="flex gap-6 mt-3 pt-3 border-t border-sky-50">
                  <label className="flex items-center gap-2 cursor-pointer" onClick={() => setSponsorOnly(!sponsorOnly)}>
                    <div className={`w-9 h-5 rounded-full transition-all relative ${sponsorOnly ? "bg-[#0ea5e9]" : "bg-gray-200"}`}>
                  ...
                  <label className="flex items-center gap-2 cursor-pointer" onClick={() => setRelocationOnly(!relocationOnly)}>
                    <div className={`w-9 h-5 rounded-full transition-all relative ${relocationOnly ? "bg-[#0ea5e9]" : "bg-gray-200"}`}>
            ...
            <div className="absolute bottom-0 left-0 right-0 overflow-hidden z-10">
              <svg className="block w-full" height="32" viewBox="0 0 1440 32" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                <path d="M0,32 L1440,32 L1440,0 C1080,32 360,0 0,16 Z" fill="#f7fbff" />
              </svg>
            </div>
          </div>
              ...
              <div className="flex items-center gap-8 flex-wrap">
                {[
                  ...
                  <div key={s.label} className="flex items-center gap-2">
                    ...
                    <span className="font-sora font-extrabold text-[#0ea5e9] text-base">{s.value}</span>
          ...
          <div className="max-w-6xl mx-auto px-6 pt-12 pb-2">
            <div className="flex items-end justify-between mb-6">
              <div>
                <span className="text-[11px] font-extrabold text-[#0ea5e9] uppercase tracking-wider block mb-1">Browse by Destination</span>
                <h2 className="font-sora font-extrabold text-[#0c1a2e] text-2xl">Where Do You Want to Work?</h2>
              </div>
              <button onClick={clearFilters} className="text-xs font-bold text-[#0ea5e9] hover:underline">View All →</button>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
              {countryCards.map(c => (
                <div
                  ...
                  className="group relative overflow-hidden rounded-2xl cursor-pointer h-40 border border-sky-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                >
                  <img src={c.img} alt={c.name} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0c1a2e]/75 via-[#0c1a2e]/20 to-transparent" />
                  {/* Flag badge */}
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-3">
                    ...
                    <div className="text-[#38bdf8] text-xs font-bold mt-0.5">{c.jobs}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <aside className="lg:col-span-3">
              <div className="bg-white border border-sky-100 rounded-2xl p-5 shadow-sm sticky top-28 space-y-5">
                <div className="flex items-center justify-between">
                  <h3 className="font-sora font-bold text-sm text-navy flex items-center gap-1.5">
                    <Filter className="w-3.5 h-3.5 text-[#0ea5e9]" /> Filters
                  </h3>
                  <button onClick={clearFilters} className="text-xs font-bold text-[#0ea5e9] hover:underline">Clear all</button>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {[
                    ...
                    <label key={item.label} className="flex items-center gap-2 cursor-pointer text-xs text-[#475569] font-semibold group">
                      <input type="checkbox" className="rounded text-[#0ea5e9] border-[#d4e8f5] w-4 h-4 accent-[#0ea5e9]" />
                ...
                <div className="space-y-2">
                  ...
                  {[
                    ...
                    <label key={item.label} className="flex items-center gap-2 cursor-pointer text-xs text-[#475569] font-semibold group">
                      <input type="checkbox" className="rounded text-[#0ea5e9] border-[#d4e8f5] w-4 h-4 accent-[#0ea5e9]" />
                      <item.icon className="w-3.5 h-3.5 text-[#94b0c4] group-hover:text-[#0ea5e9] transition-colors" />
                ...
                <button
                  onClick={applyFilters}
                  className="w-full bg-gradient-to-r from-[#38bdf8] to-[#0ea5e9] text-white font-bold py-2.5 rounded-xl text-xs shadow-md hover:shadow-lg hover:scale-[1.01] active:scale-[0.99] transition-all"
                >
                  Apply Filters
                </button>
              </div>
            ...
            <div className="lg:col-span-9 space-y-4">
              ...
              {/* Info banner */}
              <div className="bg-gradient-to-r from-amber-50 to-white border border-amber-200 border-l-4 border-l-amber-400 rounded-2xl p-4 flex gap-3">
                <Zap className="w-5 h-5 text-amber-500 shrink-0 mt-0.5" />
                <div>
                  <h4 className="text-xs font-extrabold text-amber-700 mb-0.5">Work Visa Help on Every Job</h4>
              ...
              <div className="flex items-center justify-between py-1">
                ...
                <select className="bg-white border border-sky-100 rounded-xl px-3 py-1.5 text-xs font-bold text-[#475569] outline-none">
              ...
              {/* Cards */}
              {jobs.length === 0 ? (
                <div className="bg-white border border-sky-100 rounded-2xl p-16 text-center shadow-sm">
                  <Briefcase className="w-10 h-10 text-sky-100 mx-auto mb-3" />
                  ...
                  <button onClick={clearFilters} className="text-xs font-bold text-[#0ea5e9] hover:underline">Clear All Filters</button>
                </div>
              ) : jobs.map(job => {
                const Icon = job.icon;
                return (
                  <div
                    ...
                    className={`group bg-white border rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 cursor-pointer ${
                      job.featured ? "border-l-4 border-l-[#0ea5e9] border-sky-100" : "border-sky-100"
                    }`}
                  >
                    ...
                    <div className="relative h-28 overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-[#0c1a2e]/60 via-[#0c1a2e]/10 to-transparent" />
                      ...
                      <button
                        ...
                        className="absolute top-2.5 left-2.5 w-8 h-8 bg-white/90 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/50 hover:bg-white shadow-sm transition-all"
                      >
                        {saved.includes(job.id)
                          ? <Bookmark className="w-4 h-4 text-[#0ea5e9] fill-[#0ea5e9]" />
                      ...
                      <div className="absolute bottom-2.5 left-4 flex items-center gap-2">
                        ...
                        <span className="text-white text-xs font-bold flex items-center gap-1">
                          <MapPin className="w-3 h-3 text-[#38bdf8]" />{job.location}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="p-5">
                      <div className="flex gap-4 items-start mb-3 pr-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-sora font-extrabold text-base text-[#0c1a2e] leading-snug group-hover:text-[#0ea5e9] transition-colors mb-1">
                            {job.title}
                          </h3>
                      ...
                      <div className="flex gap-1.5 flex-wrap mb-3">
                        {job.tags.map(t => (
                          <span key={t} className="bg-sky-50 text-[#0284c7] border border-[#bae6fd] px-2.5 py-0.5 rounded-md text-[10px] font-extrabold uppercase tracking-wider">{t}</span>
                        ))}
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-sky-50">
                        ...
                        <button
                          ...
                          className="bg-gradient-to-r from-[#38bdf8] to-[#0ea5e9] text-white text-xs font-bold px-5 py-2.5 rounded-xl shadow-sm hover:shadow-md hover:scale-[1.02] active:scale-[0.97] transition-all flex items-center gap-1.5 group/btn"
                        >
              ...
              <div className="text-center pt-4">
                <button
                  ...
                  className="bg-white border border-sky-100 text-[#0ea5e9] font-bold text-xs px-7 py-3 rounded-xl hover:bg-sky-50 hover:shadow-sm active:scale-[0.98] transition-all shadow-sm"
                >
                  Load More Jobs →
                </button>
              </div>
          ...
          <div className="bg-white border-y border-sky-100">
            <div className="max-w-6xl mx-auto px-6 py-12">
              <span className="text-[11px] font-extrabold text-[#0ea5e9] uppercase tracking-wider block mb-1">Verified Recruiters</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {[
                  ...
                  <div
                    ...
                    className="bg-[#f7fbff] border border-sky-100 rounded-2xl p-5 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
                  >
                    <div className="flex items-center gap-3 mb-3">
                      <img src={rc.avatar} alt={rc.name} className="w-11 h-11 rounded-xl object-cover border border-sky-100 shadow-sm" />
                      <div>
                    ...
                    <button className="w-full bg-white border border-sky-100 text-[#0ea5e9] font-bold text-[11px] py-2 rounded-xl hover:bg-sky-50 transition-all">
                      View Agency →
                    </button>
                  </div>
                ))}
          ...
          {/* ── HOW IT WORKS ── */}
          <div className="max-w-6xl mx-auto px-6 py-12">
            <span className="text-[11px] font-extrabold text-[#0ea5e9] uppercase tracking-wider block mb-1">Our Process</span>
            <h2 className="font-sora font-extrabold text-[#0c1a2e] text-xl mb-8">From Job Application to Landing Abroad</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
              {[
                { step: "01", title: "Search & Apply",      desc: "Browse 4,200+ jobs across 40+ countries with your ideal filters.",                    icon: Search,       color: "from-sky-400 to-[#0ea5e9]"   },
                { step: "02", title: "Get Offer Letter",    desc: "Receive official employer letter — the key document for your work visa.",              icon: CheckCircle,  color: "from-emerald-400 to-teal-600" },
                { step: "03", title: "Apply for Work Visa", desc: "Visara immigration expert handles LMIA, DHA, TSS 482, and EU Blue Card.",             icon: Shield,       color: "from-violet-400 to-purple-600"},
                { step: "04", title: "Fly & Start Working", desc: "Settlement support: SIM card, accommodation, and onboarding assistance.",             icon: Plane,        color: "from-amber-400 to-orange-500" },
              ].map(hs => {
                const Icon = hs.icon;
                return (
                  <div key={hs.step} className="bg-white border border-sky-100 rounded-2xl p-6 text-center shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
          ...
          <div className="max-w-5xl mx-auto px-6 pb-16">
            <div className="bg-gradient-to-r from-[#0ea5e9] via-[#0284c7] to-[#0369a1] rounded-3xl p-10 text-center shadow-2xl shadow-sky-200">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/find-experts?category=work">
                  <button className="bg-white text-[#0ea5e9] font-bold px-8 py-3.5 rounded-2xl text-sm shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-2">
                    <Shield className="w-4 h-4" /> Talk to a Visa Expert
                  </button>
                </Link>
                <button onClick={() => window.scrollTo(0, 0)} className="bg-white/15 border border-white/25 text-white font-bold px-8 py-3.5 rounded-2xl text-sm hover:bg-white/25 transition-all flex items-center gap-2">
