...
const upcomingCards = [
  {
    flag: "🇬🇧", country: "UK Visa", badgeColor: "bg-yellow-100 text-[#b91c1c] border-[#BAE6FD]",
    ...
    action: "View Slip →", actionStyle: "bg-white border border-[#BAE6FD] text-[#f59e0b] hover:bg-yellow-50",
  ...
  },
  {
    ...
    action: "Slip →", actionStyle: "bg-white border border-[#BAE6FD] text-[#f59e0b] hover:bg-yellow-50",
...
const statusBadge: Record<StatusType, string> = {
  ...
  upcoming:  "bg-yellow-50 text-[#b91c1c] border border-[#BAE6FD]",
...
const historyRows = [
  ...
  { client: "Rajesh Patil",  country: "🇨🇦 Canada PR",            centre: "Pune (Magarpatta)",         date: "18 Jun 2025 · 2:00 PM",  status: "Upcoming",  statusColor: "bg-yellow-50 text-[#b91c1c] border-yellow-200",         action: "Reschedule →", actionStyle: "bg-amber-50 border border-amber-200 text-amber-700 hover:bg-amber-100", toast: "⏰ Reschedule requested" },
  { client: "Neha Gupta",   country: "🇪🇺 Schengen (France)",     centre: "Delhi (Shivaji Stadium)",  date: "25 Jun 2025 · 11:15 AM", status: "Pending",   statusColor: "bg-amber-50 text-amber-700 border-amber-200",     action: "Refresh →", actionStyle: "bg-white border border-[#BAE6FD] text-[#f59e0b] hover:bg-yellow-50", toast: "🔄 Check VFS status" },
];
...
export function VFSBookingPortal() {
  ...
  return (
    <div className="bg-[#fff5f5] min-h-screen text-[#1A3347] font-sans pb-20">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8">
        ...
        <div className="bg-gradient-to-br from-[#F0F9FF] to-white border border-[#BAE6FD] rounded-3xl p-8 md:p-10 mb-8 text-center shadow-sm relative overflow-hidden">
          {/* Subtle glow */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#f59e0b] rounded-full opacity-[0.04] blur-3xl pointer-events-none" />
          ...
          <h1 className="font-sora font-extrabold text-3xl md:text-4xl text-[#0C1A2E] mb-3 leading-tight">
            VFS Global <span className="text-[#f59e0b]">Booking Services</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-8">
            {[
              ...
              <div key={s.label} className="text-center">
                <div className="font-sora font-extrabold text-3xl text-[#f59e0b]">{s.value}</div>
          ...
          <button
            ...
            className="bg-gradient-to-r from-[#fef08a] to-[#f59e0b] text-white font-bold px-7 py-3.5 rounded-2xl text-sm shadow-lg shadow-yellow-200 hover:shadow-yellow-300 hover:scale-[1.02] active:scale-[0.98] transition-all inline-flex items-center gap-2"
          >
          ...
          {filterChips.map(chip => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-xs font-bold border whitespace-nowrap shrink-0 transition-all ${
                activeChip === chip
                  ? "bg-gradient-to-r from-[#fef08a] to-[#f59e0b] text-white border-transparent shadow-sm"
                  : "bg-white text-[#475569] border-[#D4E8F5] hover:border-[#f59e0b] hover:text-[#f59e0b]"
              }`}
            >
              {chip}
            </button>
        ...
        <div className="mb-8">
          <span className="text-[11px] font-extrabold text-[#f59e0b] uppercase tracking-widest block mb-1">Upcoming & Pending</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {upcomingCards.map((card, i) => (
              <div
                ...
                className="bg-white border border-[#D4E8F5] rounded-2xl p-5 shadow-sm hover:shadow-xl hover:border-[#f59e0b] hover:-translate-y-1 transition-all duration-200 cursor-pointer group"
              >
                {/* Top row */}
                ...
                {/* Title */}
                <h3 className="font-sora font-bold text-base text-[#0C1A2E] mb-2 group-hover:text-[#f59e0b] transition-colors leading-snug">{card.title}</h3>
                ...
                <div className="text-sm font-bold text-[#0C1A2E] flex items-center gap-1.5 mb-4">
                  <CalendarCheck className="w-3.5 h-3.5 text-[#f59e0b] shrink-0" /> {card.date}
                </div>
        ...
        <div id="book-section" className="bg-gradient-to-br from-[#F0F9FF] to-white border-2 border-[#BAE6FD] rounded-3xl p-7 md:p-9 mb-8 shadow-sm">
          <span className="text-[11px] font-extrabold text-[#f59e0b] uppercase tracking-widest block mb-1">Agent Booking Panel</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-[#D4E8F5] rounded-xl px-4 py-3 text-sm font-semibold text-[#0C1A2E] outline-none focus:border-[#f59e0b] focus:ring-2 focus:ring-yellow-100 transition-all placeholder:text-[#C4D9E8]"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select value={country} onChange={e => setCountry(e.target.value)}
                  className="w-full bg-white border border-[#D4E8F5] rounded-xl pl-10 pr-4 py-3 text-sm font-semibold text-[#0C1A2E] outline-none focus:border-[#f59e0b] appearance-none cursor-pointer transition-all">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="date" value={prefDate} onChange={e => setPrefDate(e.target.value)}
                  className="w-full bg-white border border-[#D4E8F5] rounded-xl pl-10 pr-4 py-3 text-sm font-semibold text-[#0C1A2E] outline-none focus:border-[#f59e0b] transition-all" />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-6">
            ...
            <div>
              ...
              <input value={agentNote} onChange={e => setAgentNote(e.target.value)}
                className="w-full bg-white border border-[#D4E8F5] rounded-xl px-4 py-3 text-sm font-semibold text-[#0C1A2E] outline-none focus:border-[#f59e0b] transition-all placeholder:text-[#C4D9E8]"
                placeholder="Any special request for client?" />
            </div>
          </div>

          {/* Tip box */}
          <div className="bg-yellow-50 border-l-4 border-[#f59e0b] rounded-r-2xl px-5 py-4 mb-6 flex gap-3 items-start">
          ...
          <div className="flex gap-3 justify-end flex-wrap">
            <button onClick={handleClear}
              className="bg-white border border-[#BAE6FD] text-[#f59e0b] font-bold text-sm px-6 py-3 rounded-2xl hover:bg-yellow-50 transition-all active:scale-[0.97]">
              Clear
            </button>
            <button onClick={handleBook}
              className="bg-gradient-to-r from-[#fef08a] to-[#f59e0b] text-white font-bold text-sm px-7 py-3 rounded-2xl shadow-md shadow-yellow-200 hover:shadow-yellow-300 hover:scale-[1.01] active:scale-[0.98] transition-all flex items-center gap-2">
        ...
        <div className="mb-8">
          <span className="text-[11px] font-extrabold text-[#f59e0b] uppercase tracking-widest block mb-1">Booking History</span>
          ...
          <div className="bg-white border border-[#D4E8F5] rounded-2xl overflow-hidden shadow-sm">
            ...
            {historyRows.map((row, i) => (
              <div key={i} className={`grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-0 px-5 py-4 border-b border-[#EEF6FD] last:border-0 items-center text-sm ${i % 2 === 1 ? "bg-[#fff5f5]" : "bg-white"} hover:bg-yellow-50 transition-colors`}>
        ...
        <div className="bg-white border border-[#D4E8F5] rounded-3xl p-7 mb-8 shadow-sm">
          <span className="text-[11px] font-extrabold text-[#f59e0b] uppercase tracking-widest block mb-1">VFS Process Guide</span>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 py-4 border-t border-[#D4E8F5]">
          <button onClick={() => showToast("🔗 VFS Official website")}
            className="flex items-center gap-1.5 text-xs text-[#f59e0b] font-semibold hover:underline">
          ...
          <button onClick={() => showToast("Mon–Sat, 9 AM – 5:30 PM")}
            className="flex items-center gap-1.5 text-xs text-[#475569] font-semibold hover:text-[#f59e0b] transition-colors">
