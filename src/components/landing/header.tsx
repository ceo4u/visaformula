    ...
    <header className="sticky top-0 z-50 w-full bg-white border-b border-slate-200/80 shadow-2xs">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 lg:h-20">
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          <a
            href="/login"
            className="inline-flex items-center justify-center border-2 border-slate-300 hover:border-slate-900 bg-white hover:bg-slate-50 text-[#0c1a2e] px-6 py-2.5 min-w-[96px] rounded-xl text-[14px] font-bold transition-all shadow-2xs active:scale-95 whitespace-nowrap cursor-pointer"
          >
            Log in
          </a>
        ...
        <div className="lg:hidden bg-white border-t border-slate-200 shadow-xl max-h-[85vh] overflow-y-auto">
          <div className="p-4 space-y-2 text-xs font-bold">
            ...
            <div className="flex gap-3 px-1 pt-3 border-t border-slate-100 mt-2">
              <a href="/login" className="flex-1 text-center py-2.5 text-xs font-bold text-white bg-slate-900 hover:bg-slate-800 rounded-xl shadow-sm">Log in</a>
