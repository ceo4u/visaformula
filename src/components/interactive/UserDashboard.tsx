        ...
        <div className="flex flex-col lg:flex-row bg-[#f3f7fa] min-h-screen antialiased text-black font-roboto" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            ...
            {showProfileModal && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-md flex items-center justify-center z-[9999] p-4">
                    <div className="bg-white border border-slate-200 rounded-[28px] shadow-2xl max-w-lg w-full overflow-hidden animate-premium-fade flex flex-col max-h-[90vh]">
                        {/* Modal Header */}
                        <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                            <div>
                                <h3 className="font-extrabold text-lg text-black">Complete Your Profile</h3>
                                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Seeker Personal Details</span>
                            </div>
                            <button
                                onClick={() => setShowProfileModal(false)}
                                className="w-8 h-8 rounded-full border border-slate-200 hover:border-black flex items-center justify-center text-slate-450 hover:text-black transition-all font-bold text-sm cursor-pointer"
                            >
                                ✕
                            </button>
                        </div>
                        ...
                        <form
                            ...
                            className="p-6 space-y-5 overflow-y-auto flex-grow text-left"
                        >
                            <div className="grid grid-cols-2 gap-4">
                                <div className="col-span-1 space-y-1.5">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2.5 bg-white border border-slate-250 rounded-xl text-xs font-semibold focus:border-black outline-none shadow-sm"
                                    />
                                </div>
                                <div className="col-span-1 space-y-1.5">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="col-span-1 space-y-1.5">
                                    <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wide">Passport Country</label>
                                    <select
                                        value={modalPassportCountry}
                                        onChange={(e) => setModalPassportCountry(e.target.value)}
                                        className="w-full px-4 py-2.5 bg-white border border-slate-250 rounded-xl text-xs font-semibold focus:border-black outline-none shadow-sm cursor-pointer"
                                    >
                                ...
                                <div className="col-span-1 space-y-1.5">
                                    <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wide">Resident Of</label>
                                    <select
                            ...
                            <div className="pt-4 border-t border-slate-100 flex justify-end gap-3 bg-slate-50/20 -mx-6 -mb-6 p-6">
                                <button
                                    type="button"
                                    onClick={() => setShowProfileModal(false)}
                                    className="bg-white border border-slate-250 hover:bg-slate-50 text-slate-700 font-extrabold text-[10px] tracking-wider px-5 py-2.5 rounded-xl uppercase transition-all shadow-sm cursor-pointer"
                                >
                                    Cancel
                                </button>
                                <button
                                    type="submit"
                                    className="bg-black hover:bg-neutral-900 text-white font-extrabold text-[10px] tracking-wider px-6 py-2.5 rounded-xl uppercase transition-all shadow-sm cursor-pointer"
                                >
                                    Save Changes
                                </button>
                            </div>
