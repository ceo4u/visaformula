            ...
            <div className="flex flex-row items-center justify-center gap-8 sm:gap-16 mb-10">
                ...
                <Link href="/signup/seeker" className="group flex flex-col items-center">
                    <div className="relative circle-float-1">
                        {/* Outer pulse ring */}
                        <div className="absolute inset-[-6px] rounded-full border-2 border-gray-900/10 pulse-ring" />
                        <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-full bg-gradient-to-br from-sky-50 to-white border-[2.5px] border-gray-900 flex items-center justify-center shadow-xl group-hover:scale-110 group-hover:shadow-2xl group-hover:border-[#0ea5e9] transition-all duration-300 cursor-pointer relative z-10">
                ...
                <Link href="/register-provider" className="group flex flex-col items-center">
                    <div className="relative circle-float-2">
                        {/* Outer pulse ring */}
                        <div className="absolute inset-[-6px] rounded-full border-2 border-gray-900/10 pulse-ring" />
                        <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-full bg-gradient-to-br from-violet-50 to-white border-[2.5px] border-gray-900 flex items-center justify-center shadow-xl group-hover:scale-110 group-hover:shadow-2xl group-hover:border-[#6366f1] transition-all duration-300 cursor-pointer relative z-10">
                            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" className="sm:w-14 sm:h-14">
