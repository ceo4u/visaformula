              ...
              <div className="space-y-5 animate-premium-fade" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                ...
                <div className="space-y-3 pb-2 border-b border-slate-100">
                  <button
                    ...
                    onClick={handleGoogleSignup}
                    disabled={googleLoading}
                    className="w-full py-3.5 px-5 bg-white hover:bg-slate-50 border border-slate-300 rounded-2xl font-bold text-slate-800 flex items-center justify-center gap-3 transition-all shadow-xs cursor-pointer active:scale-[0.99] text-xs sm:text-sm"
                    style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                  >
                    {googleLoading ? (
                      <svg className="animate-spin w-4 h-4 text-slate-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
