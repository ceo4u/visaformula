...
export function AIAssistantPortal() {
    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            sender: "bot",
            text: "Hello! I am your Visara Digital Diplomat. I can help you evaluate your eligibility for study permits, skilled worker visas, and permanent residency. Which destination country are you planning to relocate to?",
            type: "choices",
        ...
        <div className="flex flex-col h-[calc(100vh-5rem)] bg-[#fff5f5]">
            ...
            <div className="bg-gradient-to-r from-purple-900 to-indigo-950 px-6 py-4 flex justify-between items-center border-b border-purple-950 shadow-sm shrink-0">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="font-sora font-extrabold text-sm text-white">Visara AI Assistant</h2>
