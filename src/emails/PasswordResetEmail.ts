...
export function generatePasswordResetEmailHtml(data: {
  ...
  const appUrl = import.meta.env.APP_URL || process.env.APP_URL || 'https://travltik.com';
...
<head>
  ...
  <title>Reset your TravlTik password</title>
</head>
          ...
          <tr>
            <td style="padding: 0 40px 32px 40px; text-align: left;">
              ...
              <div style="text-align: center; margin: 36px 0;">
                <div style="display: inline-block; background-color: #f9fafb; border: 2px dashed #00a896; color: #111827; font-size: 32px; font-weight: 800; padding: 18px 48px; border-radius: 16px; letter-spacing: 8px; font-family: Courier, monospace; box-shadow: inset 0 2px 4px 0 rgba(0, 0, 0, 0.02);">
                  ${resetToken}
                </div>
              </div>
              ...
              <div style="background-color: #fffbeb; border-left: 3px solid #d97706; border-radius: 8px; padding: 16px 20px; margin-bottom: 24px;">
                <p style="margin: 0; font-size: 13px; color: #b45309; line-height: 1.6; font-weight: 500;">
                  ⏱️ This code expires in <strong style="color: #d97706;">${expiresInMinutes} minutes</strong>.<br />
