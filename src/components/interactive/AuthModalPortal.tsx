        ...
        <div className="fixed inset-0 z-[9999] bg-slate-900/60 backdrop-blur-xs flex flex-col items-center justify-center p-2.5 sm:p-6 font-sans overflow-y-auto no-scrollbar">
            ...
            <div className="w-full max-w-2xl flex items-center justify-between mb-2 px-1 shrink-0 gap-2">
                ...
                <a href="/" className="shrink-0">
                    <img src="/logo-white.png" alt="VisaFormula Logo" className="h-7 sm:h-10 w-auto object-contain max-w-[120px] sm:max-w-none" />
                </a>
            </div>
                                    ...
                                    {!isEditingEmail ? (
                                        <div className="flex items-center justify-center gap-1.5 mt-1">
                                            ...
                                            <button
                                                ...
                                                className="inline-flex items-center gap-1 text-[11px] font-extrabold text-[#00a896] hover:text-[#008f80] hover:underline cursor-pointer bg-teal-50 px-2 py-0.5 rounded-md border border-teal-100 shrink-0"
                                            >
                                        ...
                                        <div className="flex items-center justify-center gap-2 mt-2">
                                            ...
                                            <button
                                                ...
                                                className="px-3 py-1.5 bg-[#00a896] hover:bg-[#008f80] text-white rounded-xl text-xs font-extrabold shadow-xs cursor-pointer transition-all active:scale-95 shrink-0"
                                            >
                                                Save & Send
                                            </button>
                                            <button
