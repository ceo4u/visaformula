    ...
    return (
        <div className="bg-[#fff5f5] min-h-screen pb-24 font-sans selection:bg-primary/20 selection:text-primary">
            ...
            <div className="pt-24 pb-8 text-center max-w-3xl mx-auto px-4">
                <h1 className="text-[#0c1a2e] font-sans text-4xl font-extrabold tracking-tight mb-2">
                    Contact Us
                </h1>
            ...
            <div className="max-w-6xl mx-auto px-4 mb-12">
                <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
                    <div className="bg-[#0c1a2e] text-white rounded-[24px] p-6 text-center border border-slate-800 shadow-xl relative overflow-hidden group hover:scale-[1.01] transition-all">
                        <div className="absolute top-0 right-0 w-24 h-24 bg-white/5 rounded-full blur-xl pointer-events-none" />
                        <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center mb-4 mx-auto">
                            <Phone className="w-5 h-5 text-white" />
                        </div>
                        <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Call Us</span>
                        <a href="tel:+917661989366" className="text-lg font-extrabold hover:underline">
                            +91 766 1989 366
                        </a>
                    </div>
                    ...
                    <div className="bg-[#0c1a2e] text-white rounded-[24px] p-6 text-center border border-slate-800 shadow-xl relative overflow-hidden group hover:scale-[1.01] transition-all">
                        ...
                        <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Email Us</span>
                        <a href="mailto:support@visaformula.com" className="text-lg font-extrabold hover:underline">
            ...
            <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-12 gap-8 items-start">
                ...
                <div className="md:col-span-5 bg-[#0c1a2e] text-white rounded-[24px] p-8 shadow-2xl relative overflow-hidden h-full flex flex-col justify-between">
                    ...
                    <div className="space-y-8 relative z-10">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="space-y-1">
                                <h4 className="font-extrabold text-xs text-slate-400 tracking-wider uppercase">Head Office</h4>
                                <p className="text-sm text-gray-250 font-bold leading-relaxed">
                        ...
                        <div className="flex gap-4 border-t border-white/5 pt-6">
                            ...
                            <div className="space-y-1">
                                <h4 className="font-extrabold text-xs text-slate-400 tracking-wider uppercase">Other Branches</h4>
                    ...
                    <div className="border-t border-white/10 mt-8 pt-6">
                        <div className="flex text-[9px] font-bold uppercase tracking-widest text-slate-400 justify-center">
                             <span>India</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="md:col-span-7 bg-white rounded-[24px] p-8 sm:p-10 shadow-xl border border-red-100/50">
                    <div className="mb-6">
                        <h2 className="text-[#0c1a2e] font-sans text-2xl font-extrabold">Send a Message</h2>
                        <p className="text-xs text-gray-400 font-semibold mt-1">Fill out the details below and we will get back to you within 24 hours.</p>
                    </div>

                    <form onSubmit={handleFormSubmit} className="space-y-4">
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-bold text-[#0c1a2e] uppercase tracking-wider">Full Name *</label>
                            <input 
                                type="text" 
                                required
                                value={name}
                                ...
                                className="w-full px-4 h-12 text-xs font-semibold rounded-xl border border-gray-200 focus:outline-none focus:ring-1 focus:ring-black placeholder-gray-300 shadow-sm"
                            />
                        </div>

                        <div className="grid sm:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-[#0c1a2e] uppercase tracking-wider">Email Address *</label>
                                <input 
                                    type="email" 
                                    required
                                    value={email}
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-[#0c1a2e] uppercase tracking-wider">Phone Number *</label>
                                <input 
                                    type="tel" 
                                    required
                                    value={phone}
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-bold text-[#0c1a2e] uppercase tracking-wider">Type of Visa looking for *</label>
                            <div className="relative">
                                <select 
                                    required
                                    value={visaType}
                                    onChange={(e) => setVisaType(e.target.value)}
                                    className="w-full px-4 h-12 text-xs font-bold rounded-xl border border-gray-200 focus:outline-none focus:ring-1 focus:ring-black appearance-none bg-white cursor-pointer shadow-sm"
                                >
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-bold text-[#0c1a2e] uppercase tracking-wider">Message / Requirements</label>
                            <textarea 
                                rows={4} 
                                value={message}
                                onChange={(e) => setMessage(e.target.value)}
                                placeholder="Tell us more about your case..."
                                className="w-full px-4 py-3 text-xs font-semibold rounded-xl border border-gray-200 focus:outline-none focus:ring-1 focus:ring-black placeholder-gray-300 resize-none shadow-sm"
                            ></textarea>
                        </div>

                        <div className="pt-2">
                            <button type="submit" className="w-full bg-[#0c1a2e] hover:bg-[#1a3347] text-white font-extrabold text-xs py-4 rounded-xl shadow-md hover:shadow-lg transition-all active:scale-[0.98]">
                                Submit Message
                            </button>
                        </div>
                    </form>
