        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
          ...
          <div id="section-docs" className="lg:col-span-4 bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/90 shadow-2xs space-y-5 h-full flex flex-col justify-between">
            ...
            <div className="pt-4 border-t border-slate-100 space-y-3">
              ...
              <div className="pt-1">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block mb-1.5 text-left">Explore other sections:</span>
                <div className="flex flex-wrap gap-1.5 text-[11px] font-semibold text-slate-600">
                  <button onClick={() => scrollToSection('section-financials')} className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 rounded-lg">💳 Financials</button>
                  <button onClick={() => scrollToSection('section-how-to-apply')} className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 rounded-lg">🎯 How to Apply</button>
                  <button onClick={() => scrollToSection('section-mandates')} className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 rounded-lg">🛡️ Mandates</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="section-financials" className="lg:col-span-4 bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/90 shadow-2xs space-y-5 h-full flex flex-col justify-between">
            ...
            <div className="pt-4 border-t border-slate-100 space-y-3">
              ...
              <div className="pt-1">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block mb-1.5 text-left">Explore other sections:</span>
                <div className="flex flex-wrap gap-1.5 text-[11px] font-semibold text-slate-600">
                  <button onClick={() => scrollToSection('section-docs')} className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 rounded-lg">📄 Documents</button>
                  <button onClick={() => scrollToSection('section-how-to-apply')} className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 rounded-lg">🎯 How to Apply</button>
                  <button onClick={() => scrollToSection('section-mock-prep')} className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 rounded-lg">🤖 AI Mock Interview</button>
                </div>
              </div>
            </div>
          </div>
