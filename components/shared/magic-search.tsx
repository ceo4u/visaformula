...
import { Search, Globe, MapPin, Briefcase, ChevronDown, X } from "lucide-react";
...
export function MagicSearch({ className = "" }: { className?: string }) {
    ...
    const handleSearch = () => {
        ...
        router.push(`/smart-search?${params.toString()}`);
    };

    return (
        <div className={`bg-white rounded-2xl shadow-card border border-sky-100 p-6 ${className}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                ...
                <div className="relative">
                    ...
                    <div className="relative">
                        ...
                        <select value={passport} onChange={(e) => setPassport(e.target.value)} className="w-full pl-10 pr-4 py-3 bg-sky-50/50 border border-sky-100 rounded-xl text-sm font-medium appearance-none outline-none focus:border-[#0ea5e9] focus:ring-2 focus:ring-sky-100 transition-all cursor-pointer">
                ...
                <div className="relative">
                    ...
                    <div className="relative">
                        ...
                        <select value={residing} onChange={(e) => { setResiding(e.target.value); if (e.target.value === "India") setCurrentVisa(""); }}
                            className="w-full pl-10 pr-4 py-3 bg-sky-50/50 border border-sky-100 rounded-xl text-sm font-medium appearance-none outline-none focus:border-[#0ea5e9] focus:ring-2 focus:ring-sky-100 transition-all cursor-pointer">
                            <option value="">Select country</option>
                    ...
                    <div className="relative animate-fade-up">
                        ...
                        <div className="relative">
                            ...
                            <select value={currentVisa} onChange={(e) => setCurrentVisa(e.target.value)}
                                className="w-full pl-10 pr-4 py-3 bg-amber-50/50 border border-amber-200 rounded-xl text-sm font-medium appearance-none outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-100 transition-all cursor-pointer">
            ...
            <button onClick={handleSearch}
                className="w-full bg-gradient-to-r from-[#0ea5e9] to-[#0284c7] text-white py-4 rounded-xl font-bold text-base hover:shadow-lg hover:shadow-sky-200 transition-all active:scale-[0.98] flex items-center justify-center gap-2">
