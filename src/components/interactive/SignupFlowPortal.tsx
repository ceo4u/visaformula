    ...
    return (
        <div className="min-h-screen bg-[#f4f6f9] font-sora flex flex-col items-center justify-center p-4 sm:p-6 relative selection:bg-[#00a896] selection:text-white">
            ...
            <div className="relative z-10 w-full flex flex-col items-center justify-center min-h-[90vh]">
                ...
                {/* ========================================================================= */}
                {/* VIEW 1: ROLE SELECTION MODAL ("I want to join as") - White + Turquoise Theme */}
                {/* ========================================================================= */}
                {mode === "selection" ? (
                    <div className="text-slate-900 max-w-2xl w-[94vw] sm:w-full p-6 sm:p-9 text-center space-y-6 sm:space-y-8 animate-fade-up relative my-auto bg-white border border-slate-200/90 rounded-[32px] shadow-2xl">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 py-2">
                            ...
                            <div 
                                ...
                                className="group flex flex-col items-center text-center cursor-pointer w-full sm:w-auto bg-[#f0fdfa]/60 hover:bg-[#f0fdfa] p-6 rounded-2xl border border-teal-100 hover:border-[#00a896] hover:shadow-xl transition-all"
                            >
                                ...
                                <span className="mt-4 font-black text-slate-900 text-lg group-hover:text-[#00a896] transition-colors">
                                    Visa Seeker
                                </span>
                                ...
                                <button className="w-full sm:w-auto bg-[#00a896] hover:bg-[#008f80] text-white px-6 py-2.5 rounded-xl text-xs font-extrabold flex items-center justify-center gap-2 transition-all shadow-md active:scale-95 cursor-pointer">
                            ...
                            <a 
                                href="/signup/expert"
                                className="group flex flex-col items-center text-center cursor-pointer w-full sm:w-auto bg-slate-50 hover:bg-slate-100/80 p-6 rounded-2xl border border-slate-200 hover:border-slate-400 hover:shadow-xl transition-all"
                            >
                                ...
                                <span className="mt-4 font-black text-slate-900 text-lg group-hover:text-[#0c1a2e] transition-colors">
                                    Visa Expert
                                </span>
                                <span className="text-xs text-slate-500 max-w-[200px] mt-1 mb-4 font-medium leading-relaxed">
                                    Grow your global client consulting practice
                                </span>
                                <button className="w-full sm:w-auto bg-[#0c1a2e] hover:bg-slate-800 text-white px-6 py-2.5 rounded-xl text-xs font-extrabold flex items-center justify-center gap-2 transition-all shadow-md active:scale-95 cursor-pointer">
