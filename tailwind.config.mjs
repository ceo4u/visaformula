...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: ["'Inter'", "'Google Sans'", "'Product Sans'", "Roboto", "-apple-system", "BlinkMacSystemFont", "'Segoe UI'", "sans-serif"],
        heading: ["'Google Sans'", "'Product Sans'", "'Montserrat'", "-apple-system", "sans-serif"],
        google: ["'Google Sans'", "'Product Sans'", "sans-serif"],
        inter: ["'Inter'", "-apple-system", "sans-serif"],
        montserrat: ["'Montserrat'", "'Google Sans'", "sans-serif"],
        roboto: ["Roboto", "sans-serif"],
        sora: ["'Google Sans'", "'Inter'", "sans-serif"],
        dmsans: ["'Inter'", "sans-serif"],
        plusjakarta: ["'Google Sans'", "'Inter'", "sans-serif"],
        jakarta: ["'Google Sans'", "'Inter'", "sans-serif"],
        poppins: ["'Google Sans'", "'Inter'", "sans-serif"],
      },
      boxShadow: {
