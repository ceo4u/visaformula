      ...
      {activeJob ? (
        <div className="max-w-4xl mx-auto px-6 py-10">
          <button
            ...
            className="text-xs font-bold text-[#f59e0b] hover:underline mb-6 flex items-center gap-1.5 outline-none"
          >
            ← Back to Jobs
          </button>

          {/* Hero Image */}
          <div className="relative rounded-3xl overflow-hidden h-52 mb-6 border border-yellow-100 shadow-sm">
            ...
            <div className="absolute bottom-4 left-5 flex items-center gap-2">
              ...
              <span className="text-white font-bold text-sm flex items-center gap-1">
                <MapPin className="w-3.5 h-3.5 text-[#fef08a]" /> {activeJob.location}
              </span>
            </div>
          </div>

          <div className="bg-white border border-yellow-100 rounded-2xl p-8 shadow-sm">
            <div className="flex gap-4 items-start mb-6">
              <img src={activeJob.logo} alt={activeJob.company} className="w-16 h-16 rounded-2xl object-cover border border-yellow-100 bg-white shrink-0 shadow-sm" />
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2 text-sm text-[#475569]">
                  ...
                  <span>•</span>
                  <span className="flex items-center gap-1"><Briefcase className="w-3.5 h-3.5 text-[#f59e0b]" />{activeJob.type}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
              {[
                ...
                <div key={item.label} className="bg-[#f0f9ff] border border-yellow-100 rounded-2xl p-3.5 text-center">
            ...
            <div className="flex flex-wrap gap-2 mb-5">
              {activeJob.tags.map((t: string) => (
                <span key={t} className="bg-yellow-50 text-[#d97706] border border-[#bae6fd] px-3 py-1 rounded-lg text-[10px] font-extrabold uppercase tracking-wider">{t}</span>
              ))}
            ...
            <div className="bg-[#f0f9ff] border border-[#bae6fd] rounded-2xl p-5 mb-6">
              <h4 className="text-xs font-bold text-navy flex items-center gap-2 mb-2">
                <Shield className="w-4 h-4 text-[#f59e0b]" /> Visa & Relocation Package Included
              </h4>
            ...
            <div className="flex flex-wrap gap-3 pt-4 border-t border-[#d4e8f5]">
              <button
                ...
                className="bg-gradient-to-r from-[#fef08a] to-[#f59e0b] text-white font-bold text-sm px-7 py-3.5 rounded-2xl shadow-md hover:shadow-lg hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center gap-2 outline-none"
              >
                Submit Application <ArrowRight className="w-4 h-4" />
              </button>
              <a href="/find-experts?category=work" className="block">
                <button className="bg-white border-2 border-[#bae6fd] text-[#f59e0b] font-bold text-sm px-5 py-3.5 rounded-2xl hover:bg-[#f0f9ff] transition-all flex items-center gap-2 outline-none">
        ...
        <div>
          ...
          <div className="relative overflow-hidden" style={{ minHeight: "520px" }}>
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 pt-16 pb-20">
              ...
              <h1 className="font-sora font-extrabold text-4xl sm:text-5xl md:text-6xl text-white mb-5 leading-[1.08] tracking-tight">
                Find Your Dream<br />
                <span className="bg-gradient-to-r from-[#fef08a] to-[#7dd3fc] bg-clip-text text-transparent">
                  Overseas Job.
                </span>
              </h1>
              ...
              {/* Search bar */}
              <div className="bg-white rounded-2xl p-4 shadow-2xl max-w-4xl border border-yellow-100 text-left">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
                  <div className="md:col-span-5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-[#fff5f5] border border-yellow-100 rounded-xl pl-10 pr-4 py-2.5 text-sm font-semibold text-navy outline-none focus:border-[#f59e0b] transition-all placeholder:text-gray-300"
                      />
                    </div>
                  </div>
                  <div className="md:col-span-3">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="w-full bg-[#fff5f5] border border-yellow-100 rounded-xl pl-10 pr-4 py-2.5 text-sm font-semibold text-navy outline-none focus:border-[#f59e0b] transition-all appearance-none cursor-pointer"
                      >
                  ...
                  <div className="md:col-span-1">
                    <button
                      ...
                      className="w-full h-[42px] bg-gradient-to-r from-[#fef08a] to-[#f59e0b] text-white font-bold rounded-xl shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center outline-none"
                    >
                ...
                <div className="flex gap-6 mt-3 pt-3 border-t border-yellow-50">
                  <label className="flex items-center gap-2 cursor-pointer" onClick={() => setSponsorOnly(!sponsorOnly)}>
                    <div className={`w-9 h-5 rounded-full transition-all relative ${sponsorOnly ? "bg-[#f59e0b]" : "bg-gray-200"}`}>
                  ...
                  <label className="flex items-center gap-2 cursor-pointer" onClick={() => setRelocationOnly(!relocationOnly)}>
                    <div className={`w-9 h-5 rounded-full transition-all relative ${relocationOnly ? "bg-[#f59e0b]" : "bg-gray-200"}`}>
                ...
                {[
                  ...
                  return (
                    <div key={s.label} className="flex items-center gap-2">
                      ...
                      <span className="font-sora font-extrabold text-[#f59e0b] text-base">{s.value}</span>
          ...
          <div className="max-w-6xl mx-auto px-6 pt-12 pb-2 text-left">
            <div className="flex items-end justify-between mb-6">
              <div>
                <span className="text-[11px] font-extrabold text-[#f59e0b] uppercase tracking-wider block mb-1">Browse by Destination</span>
                <h2 className="font-sora font-extrabold text-[#0c1a2e] text-2xl">Where Do You Want to Work?</h2>
              </div>
              <button onClick={clearFilters} className="text-xs font-bold text-[#f59e0b] hover:underline outline-none">View All →</button>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
              {countryCards.map(c => (
                <div
                  ...
                  className="group relative overflow-hidden rounded-2xl cursor-pointer h-40 border border-yellow-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-3">
                    ...
                    <div className="text-[#fef08a] text-xs font-bold mt-0.5">{c.jobs}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-12 gap-6 text-left">
            ...
            <aside className="lg:col-span-3">
              <div className="bg-white border border-yellow-100 rounded-2xl p-5 shadow-sm sticky top-28 space-y-5">
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={clearFilters} className="text-xs font-bold text-[#f59e0b] hover:underline outline-none">Clear all</button>
                </div>

                <div className="h-px bg-yellow-50 animate-fade-in"></div>
                ...
                <div className="space-y-2">
                  ...
                  {[
                    ...
                    <label key={item.label} className="flex items-center gap-2 cursor-pointer text-xs text-[#475569] font-semibold group">
                      <input type="checkbox" className="rounded text-[#f59e0b] border-[#d4e8f5] w-4 h-4 accent-[#f59e0b]" />
                ...
                <div className="h-px bg-yellow-50"></div>
                ...
                <div className="space-y-2">
                  ...
                  {[
                    ...
                    return (
                      <label key={item.label} className="flex items-center gap-2 cursor-pointer text-xs text-[#475569] font-semibold group">
                        <input type="checkbox" className="rounded text-[#f59e0b] border-[#d4e8f5] w-4 h-4 accent-[#f59e0b]" />
                        <CategoryIcon className="w-3.5 h-3.5 text-[#94b0c4] group-hover:text-[#f59e0b] transition-colors" />
                ...
                <button
                  onClick={applyFilters}
                  className="w-full bg-gradient-to-r from-[#fef08a] to-[#f59e0b] text-white font-bold py-2.5 rounded-xl text-xs shadow-md hover:shadow-lg hover:scale-[1.01] active:scale-[0.99] transition-all outline-none"
                >
                  Apply Filters
                </button>
              </div>
            ...
            <div className="lg:col-span-9 space-y-4">
              ...
              <div className="flex items-center justify-between py-1">
                ...
                <select className="bg-white border border-yellow-100 rounded-xl px-3 py-1.5 text-xs font-bold text-[#475569] outline-none">
              ...
              {jobs.length === 0 ? (
                <div className="bg-white border border-yellow-100 rounded-2xl p-16 text-center shadow-sm">
                  <Briefcase className="w-10 h-10 text-yellow-100 mx-auto mb-3" />
                  ...
                  <button onClick={clearFilters} className="text-xs font-bold text-[#f59e0b] hover:underline outline-none">Clear All Filters</button>
                </div>
              ) : jobs.map(job => {
                ...
                return (
                  <div
                    ...
                    className={`group bg-white border rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 cursor-pointer ${
                      job.featured ? "border-l-4 border-l-[#f59e0b] border-yellow-100" : "border-yellow-100"
                    }`}
                  >
                    <div className="relative h-28 overflow-hidden">
                      ...
                      <div className="absolute top-2.5 right-2.5 flex gap-1.5">
                        ...
                        {job.urgent && <span className="bg-yellow-50 text-amber-700 border border-yellow-200 text-[9px] font-extrabold uppercase px-2.5 py-1 rounded-md">🔴 Urgent</span>}
                      </div>
                      ...
                      >
                        {saved.includes(job.id)
                          ? <Bookmark className="w-4 h-4 text-[#f59e0b] fill-[#f59e0b]" />
                      ...
                      <div className="absolute bottom-2.5 left-4 flex items-center gap-2">
                        ...
                        <span className="text-white text-xs font-bold flex items-center gap-1">
                          <MapPin className="w-3 h-3 text-[#fef08a]" />{job.location}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="p-5">
                      <div className="flex gap-4 items-start mb-3 pr-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-sora font-extrabold text-base text-[#0c1a2e] leading-snug group-hover:text-[#f59e0b] transition-colors mb-1">
                            {job.title}
                          </h3>
                      ...
                      <div className="flex gap-1.5 flex-wrap mb-3">
                        {job.tags.map(t => (
                          <span key={t} className="bg-yellow-50 text-[#d97706] border border-[#bae6fd] px-2.5 py-0.5 rounded-md text-[10px] font-extrabold uppercase tracking-wider">{t}</span>
                        ))}
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-yellow-50">
                        ...
                        <button
                          ...
                          className="bg-gradient-to-r from-[#fef08a] to-[#f59e0b] text-white text-xs font-bold px-5 py-2.5 rounded-xl shadow-sm hover:shadow-md hover:scale-[1.02] active:scale-[0.97] transition-all flex items-center gap-1.5 group/btn outline-none"
                        >
              ...
              <div className="text-center pt-4">
                <button
                  ...
                  className="bg-white border border-yellow-100 text-[#f59e0b] font-bold text-xs px-7 py-3 rounded-xl hover:bg-yellow-50 hover:shadow-sm active:scale-[0.98] transition-all shadow-sm outline-none"
                >
                  Load More Jobs →
                </button>
              </div>
          ...
          {/* VERIFIED RECRUITERS */}
          <div className="bg-white border-y border-yellow-100 text-left">
            <div className="max-w-6xl mx-auto px-6 py-12">
              <span className="text-[11px] font-extrabold text-[#f59e0b] uppercase tracking-wider block mb-1">Verified Recruiters</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {[
                  ...
                  <div
                    ...
                    className="bg-[#fff5f5] border border-yellow-100 rounded-2xl p-5 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
                  >
                    <div className="flex items-center gap-3 mb-3">
                      <img src={rc.avatar} alt={rc.name} className="w-11 h-11 rounded-xl object-cover border border-yellow-100 shadow-sm" />
                      <div>
                    ...
                    <button className="w-full bg-white border border-yellow-100 text-[#f59e0b] font-bold text-[11px] py-2 rounded-xl hover:bg-yellow-50 transition-all outline-none">
                      View Agency →
                    </button>
                  </div>
                ))}
          ...
          <div className="max-w-6xl mx-auto px-6 py-12 text-center">
            <span className="text-[11px] font-extrabold text-red-500 uppercase tracking-wider block mb-1">Our Process</span>
            <h2 className="font-sora font-extrabold text-[#0c1a2e] text-xl mb-8">From Job Application to Landing Abroad</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
              {[
                { step: "01", title: "Search & Apply",      desc: "Browse 4,200+ jobs across 40+ countries with your ideal filters.",                    icon: Search,       color: "from-red-400 to-red-500"   },
                { step: "02", title: "Get Offer Letter",    desc: "Receive official employer letter — the key document for your work visa.",              icon: CheckCircle,  color: "from-red-400 to-red-600" },
                { step: "03", title: "Apply for Work Visa", desc: "Visara immigration expert handles LMIA, DHA, TSS 482, and EU Blue Card.",             icon: Shield,       color: "from-red-400 to-red-500"},
                { step: "04", title: "Fly & Start Working", desc: "Settlement support: SIM card, accommodation, and onboarding assistance.",             icon: Plane,        color: "from-red-400 to-red-600" },
              ].map(hs => {
                const ProcessIcon = hs.icon;
                return (
                  <div key={hs.step} className="bg-white border border-red-100 rounded-2xl p-6 text-center shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
          ...
          <div className="max-w-5xl mx-auto px-6 pb-16 text-center animate-fade-in">
            <div className="bg-gradient-to-r from-red-500 via-red-600 to-black rounded-3xl p-10 text-center shadow-2xl shadow-red-100">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/find-experts?category=work" className="block">
                  <button className="bg-white text-red-500 font-bold px-8 py-3.5 rounded-2xl text-sm shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-2 outline-none">
